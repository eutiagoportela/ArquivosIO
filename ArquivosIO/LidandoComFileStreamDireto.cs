...
public class LidandoComFileStreamDireto
{
    public void LerArquivo(string arquivo)
    {
        var enderecoDoArquivo = arquivo;//"contas.txt";
    ...
    public void LendoArquivoExibindoClasse(string enderecoDoArquivo)
    {
        using (var fluxoDeArquivo = new FileStream(enderecoDoArquivo, FileMode.Open))
        {
            var leitor = new StreamReader(fluxoDeArquivo);
    ...
    public ContaCorrente ConverterStringParaContaCorrente(string linha)
    {
